...
public class CategoryWiseExpensesActivity extends AppCompatActivity {
    TableLayout tl;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_category_wise_expenses);
        ...
        Cursor c = db.rawQuery("SELECT t.Trip_ID,t.Origin,t.Destination," +
                "e.Category,e.Amount_Spend FROM Trip_Details as t," +
                "Expense_Details as e where t.Trip_ID=e.TRIP_ID group by e.Category order by t.Trip_ID", null);
        while ((c.moveToNext())) {
